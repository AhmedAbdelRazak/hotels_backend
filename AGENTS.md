...
Never store or log PAN, CVV/CVC, expiry, credentials, or billing-address data. Never change SAR pricing, payout/cost/margin fields, stay dates, rooms, guest data, hotel assignment, reservation lifecycle, or financial-cycle state while reconciling an external capture. Never treat a declined, pending, or inconclusive Bank of America attempt as captured.
